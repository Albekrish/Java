...
public class AccountView implements AccountViewCallBack {
	...
	public void accountPage(int userId) {
		...
		switch (input) {
		case 1:
			UserDetail userDetail = accountController.profileView(userId);			
		...
		case 2:
			...
			break;
		case 3:
			List<TransHistory> transHistory = accountController.transHistory(userId);
	...
	private void moneyTransfer(int userId) {
		...
		if (accountController.moneyTransfer(tranAccountNo, tranMoney, userId)) {
