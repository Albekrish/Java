...
public class AdminView implements AdminViewCallBack {
	...
	public void init(String userId, String password) {
		...
		case 1:
			...
			userName = scan.next();
			Trainer trainer = adminController.addNewTrainer(userName);
		...
		case 2:
			...
			userName = scan.next();
			Admin admin = adminController.addNewAdmin(userName);
		...
		case 3: // viewCourse
			...
			List<Course> courses = adminController.getCourse(courseName);
		...
		case 4: // Add Course
			...
			tName = scan.next();
			if (adminController.addCourse(courseName, cMoney, tName)) {
